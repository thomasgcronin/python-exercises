...
with open("the_koran.txt", "r") as f:
    txt = f.read()
...
for word in txt_list:
    #print "word?: " + word
    if word in the_koran:
        #increment
        the_koran[word] += 1
        #the_koran[word] = the_koran [word] + 1
...
f = (line for line in open("the_koran.txt").xreadlines())  # how much is loaded in memory?
